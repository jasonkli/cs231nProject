...
def parseArguments():
    ...
    return dtype, device, baseline, batch_size, learning_rate, epochs, filename, description
...
def main():
    global dtype, device, baseline, batch_size, learning_rate, epochs, filename, description
    dtype, device, baseline, batch_size, learning_rate, epochs, filename, description = parseArguments()
    model, optimizer = createModel()
    best_acc, best_model = train(model, optimizer, num_epochs=epochs)
